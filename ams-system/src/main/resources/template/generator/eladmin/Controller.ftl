...
public class ${className}Controller {
    ...
    @PreAuthorize("@ams.check('${changeClassName}:list')")
    ...
    @PreAuthorize("@ams.check('${changeClassName}:add')")
    ...
    @PreAuthorize("@ams.check('${changeClassName}:edit')")
    ...
    @PreAuthorize("@ams.check('${changeClassName}:del')")
