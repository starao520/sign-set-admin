...
public class QiniuController {
    ...
    @Log("访客查询最新文件")
    @ApiOperation("访客查询最新文件")
    @AnonymousGetMapping(value = "/visitor")
    public ResponseEntity<Object> queryFileList(Pageable pageable){
        return new ResponseEntity<>(qiNiuService.queryFileList(pageable), HttpStatus.OK);
    }

    @Log("访客查询最热文件")
    @ApiOperation("访客查询最热文件")
    @AnonymousGetMapping(value = "/praise")
    public ResponseEntity<Object> queryPraiseList(Pageable pageable){
        return new ResponseEntity<>(qiNiuService.queryPraiseList(pageable), HttpStatus.OK);
    }
